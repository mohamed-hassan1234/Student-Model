...
1. Register a proposed website or file source.
2. Validate curriculum topic, source type, URL/file safety, license type, and permissions.
3. Human reviewer approves or rejects the source.
